...
<div class="row">
    <div class="col-12 grid-margin">
        <div class="card">
            <div class="card-body">
                <h2 class="card-title">Quản lý câu hỏi</h2>
                <form class="boloc" action="index.php?act=list_cauhoi" method="post">
                    <div class="boloc2 form-group">
                        <div class="thaotac">
                            <a href="index.php?act=add_cauhoi"><input class="btn btn-gradient-primary" type="button"
                                    value="Thêm câu hỏi"></a>
                        </div>
                    ...
                    <table class="table text-center table-bordered table1">
                        ...
                        <tbody>
                            ...
                            foreach ($listcauhoi as $cauhoi) {
                                extract($cauhoi);
                                $suasp = "index.php?act=edit_cauhoi&ID=" . $ID;
                                $xoasp = "index.php?act=delete_cauhoi&ID=" . $ID;
