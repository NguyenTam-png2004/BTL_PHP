            ...
            <div class="card-body">
                ...
                <form class="boloc" action="index.php?act=list_nguphap" method="post">
                    <div class="boloc2 form-group">
                        <div class="thaotac">
                            <a href="index.php?act=add_nguphap"><input class="btn btn-gradient-primary" type="button"
                                    value="Thêm ngữ pháp"></a>
                        </div>
                ...
                <div class="table-responsive">
                    <table class="table text-center table-bordered table1">
                        ...
                        <tbody>
                            ...
                            <?php
              $i = 1;
              foreach ($listnguphap as $nguphap) {
                extract($nguphap);
                $suasp = "index.php?act=edit_nguphap&ID=" . $ID;
                $xoasp = "index.php?act=delete_nguphap&ID=" . $ID;
                echo '<tr>
                <td>' . $i . '</td>
                <td>' . $name . '</td>
                <td>' . $grammar  . '</td>
